...
let bundle_cart : Bundle<Cart, CartForm> =
    {
      ...
      view_edit = Some view_edit_cart
      view_create = Some view_create_cart
      view_generate = Some view_generate_cart
      view_view = Some view_view_cart
      view_search = None
      view_edit_errored = Some view_edit_errored_cart
      view_create_errored = Some view_create_errored_cart
      view_generate_errored = Some view_generate_errored_cart
...
let bundle_checkout : Bundle<Checkout, CheckoutForm> =
    {
      ...
      convertForm = Some convert_checkoutForm
      ...
      view_edit = Some view_edit_checkout
      view_create = Some view_create_checkout
      view_generate = Some view_generate_checkout
      view_view = Some view_view_checkout
      view_search = None
      view_edit_errored = Some view_edit_errored_checkout
      view_create_errored = Some view_create_errored_checkout
      view_generate_errored = Some view_generate_errored_checkout
